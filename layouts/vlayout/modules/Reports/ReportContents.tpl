...
{strip}
	<script type="text/javascript">
		/* Add jquery to freeze the first and last columns of the table */
        jQuery(document).ready(function(){
            ...
            jQuery("#contentsTable").dataTable({
                searching: false,
                order: [[ 0, "desc" ]],
                scrollY:        "300px",
                scrollX:        true,
        ...
        /*
        *purpose: allow user to sort the report table
        *added by: dave
        * date: 8/30/2017
        * */
	</script>
	...
	<div id="reportDetails">
			...
			<table id="detailsTable" class=" table-bordered table-condensed marginBottom10px" width="100%">
				<thead>
		...
		{if $DATA neq ''}
			...
			<table id="contentsTable" class="stripe row-border order-column" cellspacing="0" width="100%">
				<thead>
					<tr class="blockHeader">
...
<script type="text/javascript">
	/* Put some colors on status */
    $( "td:contains('Offer Made') " ).attr( "style", "background-color:yellow; color:black;" );
    $( "td:contains('Declined')" ).attr( "style", "background-color:purple; color:white;" );
</script>
{/strip}
